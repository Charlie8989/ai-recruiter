...
export const retrieveEntries = async (supabase) => {
...
export const insertRandom = async (supabase, randomString) => {
  const upsertData = {
...
export const deleteRandom = async (supabase, entryToDelete) => {
...
export const determineAction = async (supabase) => {
